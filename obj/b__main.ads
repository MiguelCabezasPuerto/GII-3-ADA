...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#c37c5217#;
   ...
   u00061 : constant Version_32 := 16#8332779a#;
   pragma Export (C, u00061, "ada__tagsB");
   u00062 : constant Version_32 := 16#02144d76#;
   pragma Export (C, u00062, "ada__tagsS");
   u00063 : constant Version_32 := 16#e6965fe6#;
   pragma Export (C, u00063, "system__val_unsB");
   u00064 : constant Version_32 := 16#c65ffadb#;
   pragma Export (C, u00064, "system__val_unsS");
   u00065 : constant Version_32 := 16#46a1f7a9#;
   pragma Export (C, u00065, "system__val_utilB");
   u00066 : constant Version_32 := 16#b7bbde89#;
   pragma Export (C, u00066, "system__val_utilS");
   u00067 : constant Version_32 := 16#b7fa72e7#;
   pragma Export (C, u00067, "system__case_utilB");
   u00068 : constant Version_32 := 16#110a2b1e#;
   pragma Export (C, u00068, "system__case_utilS");
   u00069 : constant Version_32 := 16#f7ab51aa#;
   pragma Export (C, u00069, "system__finalization_rootB");
   u00070 : constant Version_32 := 16#bd6af943#;
   pragma Export (C, u00070, "system__finalization_rootS");
   u00071 : constant Version_32 := 16#57a37a42#;
   pragma Export (C, u00071, "system__address_imageB");
   u00072 : constant Version_32 := 16#1dfad6ac#;
   pragma Export (C, u00072, "system__address_imageS");
   u00073 : constant Version_32 := 16#7268f812#;
   pragma Export (C, u00073, "system__img_boolB");
   u00074 : constant Version_32 := 16#49cf3a7d#;
   pragma Export (C, u00074, "system__img_boolS");
   u00075 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00075, "system__ioB");
   u00076 : constant Version_32 := 16#2254bcd9#;
   pragma Export (C, u00076, "system__ioS");
   u00077 : constant Version_32 := 16#d21112bd#;
   pragma Export (C, u00077, "system__storage_poolsB");
   u00078 : constant Version_32 := 16#a9b91ff2#;
   pragma Export (C, u00078, "system__storage_poolsS");
   u00079 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00079, "ada__numericsS");
   u00080 : constant Version_32 := 16#fe77d4bb#;
   pragma Export (C, u00080, "ada__real_timeB");
   u00081 : constant Version_32 := 16#5bfb6637#;
   pragma Export (C, u00081, "ada__real_timeS");
   u00082 : constant Version_32 := 16#763c483e#;
   pragma Export (C, u00082, "system__arith_64B");
   u00083 : constant Version_32 := 16#eb7a6d66#;
   pragma Export (C, u00083, "system__arith_64S");
   u00084 : constant Version_32 := 16#5857c1f4#;
   pragma Export (C, u00084, "system__taskingB");
   u00085 : constant Version_32 := 16#76b1e09e#;
   pragma Export (C, u00085, "system__taskingS");
   u00086 : constant Version_32 := 16#4ea2a83e#;
   pragma Export (C, u00086, "system__task_primitivesS");
   u00087 : constant Version_32 := 16#ce13ac8b#;
   pragma Export (C, u00087, "system__os_interfaceS");
   u00088 : constant Version_32 := 16#b3abd60c#;
   ...
   u00090 : constant Version_32 := 16#5fc6897f#;
   pragma Export (C, u00090, "system__task_primitives__operationsB");
   u00091 : constant Version_32 := 16#43202745#;
   pragma Export (C, u00091, "system__task_primitives__operationsS");
   u00092 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00092, "system__float_controlB");
   u00093 : constant Version_32 := 16#5cea08aa#;
   pragma Export (C, u00093, "system__float_controlS");
   u00094 : constant Version_32 := 16#1826115c#;
   pragma Export (C, u00094, "system__interrupt_managementB");
   u00095 : constant Version_32 := 16#437cbff6#;
   pragma Export (C, u00095, "system__interrupt_managementS");
   u00096 : constant Version_32 := 16#c313b593#;
   pragma Export (C, u00096, "system__multiprocessorsB");
   u00097 : constant Version_32 := 16#84bad4e5#;
   pragma Export (C, u00097, "system__multiprocessorsS");
   u00098 : constant Version_32 := 16#5052be8c#;
   pragma Export (C, u00098, "system__task_infoB");
   u00099 : constant Version_32 := 16#3ea45c99#;
   pragma Export (C, u00099, "system__task_infoS");
   u00100 : constant Version_32 := 16#42bf477b#;
   pragma Export (C, u00100, "system__tasking__debugB");
   u00101 : constant Version_32 := 16#f32cb5c6#;
   pragma Export (C, u00101, "system__tasking__debugS");
   u00102 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00102, "system__concat_2B");
   u00103 : constant Version_32 := 16#47c6b96a#;
   pragma Export (C, u00103, "system__concat_2S");
   u00104 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00104, "system__concat_3B");
   u00105 : constant Version_32 := 16#ca3c49fc#;
   pragma Export (C, u00105, "system__concat_3S");
   u00106 : constant Version_32 := 16#c9fdc962#;
   pragma Export (C, u00106, "system__concat_6B");
   u00107 : constant Version_32 := 16#7bdcbe82#;
   pragma Export (C, u00107, "system__concat_6S");
   u00108 : constant Version_32 := 16#def1dd00#;
   pragma Export (C, u00108, "system__concat_5B");
   u00109 : constant Version_32 := 16#ac2f8537#;
   pragma Export (C, u00109, "system__concat_5S");
   u00110 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00110, "system__concat_4B");
   u00111 : constant Version_32 := 16#be49a828#;
   pragma Export (C, u00111, "system__concat_4S");
   u00112 : constant Version_32 := 16#13cbc1ce#;
   pragma Export (C, u00112, "system__crtlS");
   u00113 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00113, "system__img_enum_newB");
   u00114 : constant Version_32 := 16#3b118066#;
   pragma Export (C, u00114, "system__img_enum_newS");
   u00115 : constant Version_32 := 16#194ccd7b#;
   pragma Export (C, u00115, "system__img_unsB");
   u00116 : constant Version_32 := 16#49032b17#;
   pragma Export (C, u00116, "system__img_unsS");
   u00117 : constant Version_32 := 16#cec2da0b#;
   pragma Export (C, u00117, "system__stack_usageB");
   u00118 : constant Version_32 := 16#1102a6a9#;
   pragma Export (C, u00118, "system__stack_usageS");
   u00119 : constant Version_32 := 16#a0dcd313#;
   pragma Export (C, u00119, "ada__real_time__delaysB");
   u00120 : constant Version_32 := 16#6becaccd#;
   pragma Export (C, u00120, "ada__real_time__delaysS");
   u00121 : constant Version_32 := 16#7a8f4ce5#;
   pragma Export (C, u00121, "ada__text_ioB");
   u00122 : constant Version_32 := 16#e76e8bfb#;
   pragma Export (C, u00122, "ada__text_ioS");
   u00123 : constant Version_32 := 16#7a48d8b1#;
   pragma Export (C, u00123, "interfaces__c_streamsB");
   u00124 : constant Version_32 := 16#40dd1af2#;
   pragma Export (C, u00124, "interfaces__c_streamsS");
   u00125 : constant Version_32 := 16#efe3a128#;
   pragma Export (C, u00125, "system__file_ioB");
   u00126 : constant Version_32 := 16#b1614c7b#;
   pragma Export (C, u00126, "system__file_ioS");
   u00127 : constant Version_32 := 16#b46168d5#;
   pragma Export (C, u00127, "ada__io_exceptionsS");
   u00128 : constant Version_32 := 16#a50435f4#;
   pragma Export (C, u00128, "system__crtl__runtimeS");
   u00129 : constant Version_32 := 16#9cd5d2c4#;
   pragma Export (C, u00129, "system__os_libB");
   u00130 : constant Version_32 := 16#a6d80a38#;
   pragma Export (C, u00130, "system__os_libS");
   u00131 : constant Version_32 := 16#4cd8aca0#;
   pragma Export (C, u00131, "system__stringsB");
   u00132 : constant Version_32 := 16#0bfc0152#;
   pragma Export (C, u00132, "system__stringsS");
   u00133 : constant Version_32 := 16#6329a5ac#;
   pragma Export (C, u00133, "system__file_control_blockS");
   u00134 : constant Version_32 := 16#ebb6b8da#;
   pragma Export (C, u00134, "system__pool_globalB");
   u00135 : constant Version_32 := 16#f2b3b4b1#;
   pragma Export (C, u00135, "system__pool_globalS");
   u00136 : constant Version_32 := 16#67335317#;
   pragma Export (C, u00136, "system__memoryB");
   u00137 : constant Version_32 := 16#769df783#;
   pragma Export (C, u00137, "system__memoryS");
   u00138 : constant Version_32 := 16#2312354c#;
   pragma Export (C, u00138, "powerplant_pB");
   u00139 : constant Version_32 := 16#ab6d4f55#;
   pragma Export (C, u00139, "powerplant_pS");
   u00140 : constant Version_32 := 16#29548666#;
   pragma Export (C, u00140, "system__tasking__protected_objectsB");
   u00141 : constant Version_32 := 16#e2c8a7eb#;
   pragma Export (C, u00141, "system__tasking__protected_objectsS");
   u00142 : constant Version_32 := 16#4a908754#;
   pragma Export (C, u00142, "system__soft_links__taskingB");
   u00143 : constant Version_32 := 16#2e7c4429#;
   ...
   u00145 : constant Version_32 := 16#8f97a854#;
   pragma Export (C, u00145, "ada__exceptions__is_null_occurrenceS");
   u00146 : constant Version_32 := 16#58c58b5e#;
   pragma Export (C, u00146, "ada__calendar__formattingB");
   u00147 : constant Version_32 := 16#7ece677a#;
   pragma Export (C, u00147, "ada__calendar__formattingS");
   u00148 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00148, "ada__calendar__time_zonesB");
   u00149 : constant Version_32 := 16#74a1fd86#;
   pragma Export (C, u00149, "ada__calendar__time_zonesS");
   u00150 : constant Version_32 := 16#7993dbbd#;
   pragma Export (C, u00150, "system__val_intB");
   u00151 : constant Version_32 := 16#f4b361a9#;
   pragma Export (C, u00151, "system__val_intS");
   u00152 : constant Version_32 := 16#730c1f82#;
   pragma Export (C, u00152, "system__val_realB");
   u00153 : constant Version_32 := 16#423f3c87#;
   pragma Export (C, u00153, "system__val_realS");
   u00154 : constant Version_32 := 16#0be1b996#;
   pragma Export (C, u00154, "system__exn_llfB");
   u00155 : constant Version_32 := 16#3d925579#;
   pragma Export (C, u00155, "system__exn_llfS");
   u00156 : constant Version_32 := 16#ec662de1#;
   pragma Export (C, u00156, "system__powten_tableS");
   u00157 : constant Version_32 := 16#d7f0d61d#;
   pragma Export (C, u00157, "ada__real_time__timing_eventsB");
   u00158 : constant Version_32 := 16#f230ff5f#;
   pragma Export (C, u00158, "ada__real_time__timing_eventsS");
   u00159 : constant Version_32 := 16#5e196e91#;
   pragma Export (C, u00159, "ada__containersS");
   u00160 : constant Version_32 := 16#0110e3c6#;
   pragma Export (C, u00160, "system__interrupt_management__operationsB");
   u00161 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00161, "system__interrupt_management__operationsS");
   u00162 : constant Version_32 := 16#a6e358bc#;
   pragma Export (C, u00162, "system__stream_attributesB");
   u00163 : constant Version_32 := 16#e89b4b3f#;
   pragma Export (C, u00163, "system__stream_attributesS");
   u00164 : constant Version_32 := 16#8921cdce#;
   pragma Export (C, u00164, "system__tasking__rendezvousB");
   u00165 : constant Version_32 := 16#9b7e32a8#;
   pragma Export (C, u00165, "system__tasking__rendezvousS");
   u00166 : constant Version_32 := 16#386436bc#;
   pragma Export (C, u00166, "system__restrictionsB");
   u00167 : constant Version_32 := 16#4fcd432c#;
   pragma Export (C, u00167, "system__restrictionsS");
   u00168 : constant Version_32 := 16#d4c29667#;
   pragma Export (C, u00168, "system__tasking__entry_callsB");
   u00169 : constant Version_32 := 16#687efea4#;
   pragma Export (C, u00169, "system__tasking__entry_callsS");
   u00170 : constant Version_32 := 16#25087fbf#;
   pragma Export (C, u00170, "system__tasking__initializationB");
   u00171 : constant Version_32 := 16#7f6b69f1#;
   pragma Export (C, u00171, "system__tasking__initializationS");
   u00172 : constant Version_32 := 16#1bc6a741#;
   pragma Export (C, u00172, "system__tasking__protected_objects__entriesB");
   u00173 : constant Version_32 := 16#f2cd5189#;
   pragma Export (C, u00173, "system__tasking__protected_objects__entriesS");
   u00174 : constant Version_32 := 16#fe905a38#;
   pragma Export (C, u00174, "system__tasking__protected_objects__operationsB");
   u00175 : constant Version_32 := 16#a0186ad7#;
   pragma Export (C, u00175, "system__tasking__protected_objects__operationsS");
   u00176 : constant Version_32 := 16#e954ed7e#;
   pragma Export (C, u00176, "system__tasking__queuingB");
   u00177 : constant Version_32 := 16#ee1cad28#;
   pragma Export (C, u00177, "system__tasking__queuingS");
   u00178 : constant Version_32 := 16#95d44227#;
   pragma Export (C, u00178, "system__tasking__utilitiesB");
   u00179 : constant Version_32 := 16#b8d04f49#;
   pragma Export (C, u00179, "system__tasking__utilitiesS");
   u00180 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00180, "system__traces__taskingB");
   u00181 : constant Version_32 := 16#becc801d#;
   pragma Export (C, u00181, "system__traces__taskingS");
   u00182 : constant Version_32 := 16#ad8e951d#;
   pragma Export (C, u00182, "system__tasking__stagesB");
   u00183 : constant Version_32 := 16#bfafc253#;
   pragma Export (C, u00183, "system__tasking__stagesS");
   u00184 : constant Version_32 := 16#036cdb71#;
   pragma Export (C, u00184, "system__random_numbersB");
   u00185 : constant Version_32 := 16#15d8f305#;
